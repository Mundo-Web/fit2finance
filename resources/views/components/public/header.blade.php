                            ...
                            <div class="flex flex-col md:flex-row">
                                <div
                                    ...
                                    <div class="flex flex-col items-center md:flex-row justify-between gap-5">
                                        <div>
                                            <img src="{{ asset('images/img/logo_modal_finanace.webp') }}"
                                                alt="fit2finance" />
                                        </div>
                                    ...
                                    <div class="flex flex-col gap-4">
                                        <h1
                                            class="font-corbel_700 text-[40px] lg:text-[64px] leading-none md:leading-tight">
                                    ...
                                    <div>
                                        <form class="flex flex-col gap-10 text-text18 xl:text-text22"
                                            id="headerFormulario">
                                            @csrf
                                            <div>
                                            ...
                                            <div>
                                                <input type="tel" id="telefono" maxlength="9"
                                                    placeholder="Teléfono" required name="phone"
                                                    class="focus:outline-none w-full bg-transparent pt-4 pl-4 pb-4 font-corbel_400 text-text18 xl:text-text22 text-white placeholder:text-white placeholder:opacity-35" />
                                            </div>
                                ...
                                <div class="justify-center items-center flex basis-1/2">
                                    <img src="{{ asset('images/img/imagen_2_modal.webp') }}" alt=""
                                        class="w-full h-full" />
                                </div>
                            </div>
                        </div>
