...
<!-- --- -->
<header id="inicio">
  <div class="bg-fondo_mobile md:bg-imagen_header bg-cover bg-center bg-no-repeat sm:w-full h-full">
              ...
              <div class="flex flex-col md:flex-row">
                <div
                  ...
                  <div class="flex flex-col items-center md:flex-row justify-between gap-5">
                    <div>
                      <img src="{{ asset('images/img/logo_modal_finanace.png') }}" alt="fit2finance" />
                    </div>
                ...
                <div class="justify-center items-center flex basis-1/2">
                  <img src="{{ asset('images/img/imagen_2_modal.png') }}" alt="" class="w-full h-full" />
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="bg-[#505977] bg-HeaderMobile2 md:bg-header_mobile_5 bg-cover bg-center bg-no-repeat sm:w-full h-full">
    <div class="w-11/12 mx-auto flex justify-between items-center py-10" data-aos="fade-up" data-aos-offset="150">
      <a href="/">
        <div>
      ...
      <div>
        <nav class="text-white hidden md:flex gap-5 font-bold text-text18 xl:text-text22">
          ...
          <a href="#contacto" class="rounded-full hover:bg-colorBackgroundHeader md:duration-300 py-2 px-5">Contacto
          </a>
        </nav>
      </div>
