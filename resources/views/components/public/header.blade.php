  ...
  <header id="inicio">
    ...
    >
      ...
      >
        <div data-aos="fade-up" data-aos-offset="150">
          ...
          <p
            class="font-normal text-textWhiteWeak text-text18 xl:text-text22"
          >
        ...
        <div class="w-full md:w-auto" >
          ...
          >
            <div
              class="relative top-[48px] mx-auto shadow-xl rounded-md bg-white max-w-md md:max-w-[1150px]"
            >
                ...
                <div class="flex flex-col md:flex-row">
                  ...
                  >
                    ...
                    >
                      <div>
                        <img
                        src="{{asset('images/img/logo_modal_finanace.png')}}"
                      ...
                      <a
                        href="#"
                        class="font-bold text-text14 xl:text-text18"
                      >
                    ...
                    <div class="flex flex-col gap-4">
                      <h1
                        class="font-bold text-[40px] lg:text-[64px] leading-none md:leading-tight"
                      >
                    ...
                    <div>
                      <form
                        action="#"
                        class="flex flex-col gap-10 text-text18 xl:text-text22"
                      >
                        <div>
                          <input
                            type="text"
                  ...
                  <div class="justify-center items-center flex basis-1/2">
                    <img
                    src="{{asset('images/img/imagen_2_modal.png')}}"
    ...
    >
      ...
      >
        ...
        <div>
          <nav
            class="text-white hidden md:flex gap-5 font-bold text-text18 xl:text-text22"
          >
            <a
              href="index.html"
              class="py-2 px-5 flex gap-2 justify-center items-center"
            >
              <img 
              src="{{asset('images/svg/point_naranja.svg')}}"
             alt="point" />
              <span>Inicio</span>
            </a>
            <a
              href="#"
              class="py-2 px-5 flex justify-center items-center gap-3"
            >
              <span>Servicios</span>
            </a>
            <a
