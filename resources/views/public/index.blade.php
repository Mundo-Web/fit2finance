  ...
  <main>
        ...
        @foreach ($service as $item)
          <div class="swiper-slide swiper-slide-flex bg-bgPurpose p-5">
            <div class="flex flex-col justify-between">
              ...
              <div>
                <div class="my-8">
                  <img src="{{ asset($item->url_image . '/' . $item->name_image) }}" alt="outsourcing_financiero">
                ...
                <a href="https://api.whatsapp.com/send?phone={{ $generales->whatsapp }}&text={{ $generales->mensaje_whatsapp }}"
                  ...
                  <div>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                      ...
                      <path
                        d="M2.40039 16.7992L7.77639 11.63L12.3844 16.0608L21.6004 7.19922M21.6004 7.19922H14.6884M21.6004 7.19922V13.8454"
                        stroke="#E38533" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </div>
                </a>
              </div>
    ...
    <section class="bg-gradient-to-r from-[#505977] to-[#424962] my-24">
      <div class="2md:w-10/12 mx-auto" data-aos="fade-up" data-aos-offset="150">
        <div class="grid grid-cols-1 2md:grid-cols-2 mt-0 pb-12 2md:py-20 text-textWhite gap-10">
          ...
          <div class="col-span-1 2md:col-span-1 order-3 2md:order-2 flex flex-col justify-between gap-10 px-8 2md:px-0">
    ...
    <section class="bg__diferenciales-banner bg-cover bg-center bg-no-repeat sm:w-full h-full">
      <div class="w-11/12 mx-auto py-12 md:py-32">
        <h2 class="font-corbel_700 text-text40 xl:text-text60 text-textGray text-center leading-none md:leading-tight">
          Ventajas diferenciales
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 my-16" data-aos="fade-up" data-aos-offset="150">
          <div class="flex gap-5">
            <div class="flex justify-center items-start">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="32" cy="32" r="32" fill="#E38533" />
                <mask id="mask0_28_3467" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="16" y="16"
                  width="32" height="32">
          ...
          <div class="flex gap-5">
            <div class="flex justify-center items-start">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="32" cy="32" r="32" fill="#E38533" />
                <mask id="mask0_28_3456" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="16" y="16"
                  width="32" height="32">
                  <rect x="16" y="16" width="32" height="32" fill="#D9D9D9" />
                </mask>
          ...
          <div class="flex gap-5">
            <div class="flex justify-center items-start">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="32" cy="32" r="32" fill="#E38533" />
                <mask id="mask0_28_3480" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="16" y="16"
                  width="32" height="32">
                  <rect x="16" y="16" width="32" height="32" fill="#D9D9D9" />
                </mask>
          ...
          <div class="flex gap-5">
            <div class="flex justify-center items-start">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="32" cy="32" r="32" fill="#E38533" />
                <mask id="mask0_231_9166" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="15" y="16"
                  width="33" height="33">
                    ...
                    <a href="{{ route('publicacion') }}"
                      ...
                      <div>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                          ...
                          <path
                            d="M2.40039 16.7992L7.77639 11.63L12.3844 16.0608L21.6004 7.19922M21.6004 7.19922H14.6884M21.6004 7.19922V13.8454"
                            stroke="#505977" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                      </div>
                    </a>
                  </div>
                ...
                <div class="dropdown w-full">
                  ...
                  <div class="list overflow-y-scroll scroll-cursos">
                    <div class="w-full">
                      ...
                      <label for="id10"
                        class="font-corbel_400 text-text18 xl:text-text22 hover:font-corbel_700 md:duration-100">Tipo de
                        servicios</label>
                    </div>
