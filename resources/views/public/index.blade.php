    ...
    <section class="bg-gradient-to-r from-[#505977] to-[#424962] my-24">
      <div class="2md:w-10/12 mx-auto" data-aos="fade-up" data-aos-offset="150">
        <div class="grid grid-cols-1 2md:grid-cols-2 mt-0 pb-12 2md:py-20 text-textWhite gap-10">
          ...
          <div class="col-span-1 2md:col-span-1 order-3 2md:order-2 flex flex-col justify-between gap-10 px-5 2md:px-0">
    ...
    <section class="mt-24">
      <div class="grid grid-cols-1 lg:grid-cols-2" id="contacto">
        <div class="relative bg-[#505977]">
          ...
          <img src="{{ asset('images/img/wome_3.webp') }}" alt="fit2finance" class="w-full h-full hidden lg:block">
          <img src="{{ asset('images/img/wome_2.webp') }}" alt="fit2finance" class="w-full h-full block lg:hidden">
        </div>
        <div class="bg-bgGray text-textWhite flex flex-col justify-center lg:py-10">
          <div class="w-11/12 mx-auto lg:mx-0 py-12 lg:pt-0 lg:pl-10 lg:w-[70%] flex flex-col gap-10 justify-center ">
            ...
            <form id="formContactos" class="flex flex-col gap-5" data-aos="fade-up" data-aos-offset="150">
              @csrf
              <div>
                <input required name="full_name" id="fullNameContacto" type="text" placeholder="Nombre completo"
              ...
              <input type="hidden" id="tipo" placeholder="tipo" name="tipo_message" value="Contactos" />
